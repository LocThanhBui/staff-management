              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    ...
                    <td>
                      <input class="min-le" type="text" value="" name="code" id="code" required>
                    </td>
                  </tr>
                  <tr>
                    <td>STAFF NAME</td>
                    <td><input class="min-le" type="text" name="name" value="" id="name" required></td>
                  </tr>
                  <tr>
                    <td>BIRTHDAY</td>
                    <td><input class="min-le" type="date" name="birthday" value="" id="birthday" required></td>
                  </tr>
                  <tr>
                    <td>TEL 1</td>
                    <td><input class="min-le" type="text" name="tel1" value="" id="tel1" required></td>
                  </tr>
                  <tr>
                    <td>TEL 2</td>
                    <td><input class="min-le" type="text" name="tel2" value="" id="tel2" required></td>
                  </tr>
                  <tr>
                    <td>ZIPNO</td>
                    <td><input class="min-le" type="text" name="zip" value="" id="zip" required></td>
                  </tr>
                  <tr>
                    <td>ADDRESS 1</td>
                    <td><input class="min-le" type="text" name="address1" value="" id="address1" required></td>
                  </tr>
                  <tr>
                    <td>ADDRESS 2</td>
                    <td><input class="min-le" type="text" name="address2" value="" id="address2" required></td>
                  </tr>
                  <tr>
                    <td>NOTE</td>
                    <td><input class="min-le" type="text" name="note" value="" id="note"></td>
                  </tr>
                  <tr id="onHide">
                    <td>USEFLAG</td>
