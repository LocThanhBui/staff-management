...
<body>
  ...
  <div class="container">
              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    ...
                    <td>
                      <input onchange="codeLength()"  type="text" value="" name="code" id="code"   pattern="^[0-9]{4}" required>
                    </td>
                  </tr>
                  <tr>
                    <td>STAFF NAME</td>
    ...
    e vent.target.setCustomValidity('Username should only contain lowercase letters. e.g. john');
}
    </script>
