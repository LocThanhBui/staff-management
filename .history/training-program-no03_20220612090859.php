          ...
          <form action="" method="POST">
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  <td>TEL 3</td>
                  <td><input type="text" name="tel3" value="<?php echo $row["tel2"]; ?>" id="tel3_ref" pattern="[0-9]{1,20}" 
                    title="TEL 2 không vượt quá 20 ký tự" required></td>
                </tr>
                <tr>
                  <td>ZIP NO</td>
              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  if (isset($_POST['btn_Add'])) {
                    ...
                    $sqlAdd = " INSERT INTO `m_user` (`code`, `name`, `birthday`, `tel1`, `tel2`,`tel3` , `zipno`, `address1`, `address2`, `note`, `useflag`) VALUES ('$staff_code', '$staff_name', '$birthday', '$tel1', '$tel2', '$tel3','$zip', '$add1', '$add2', '$note', 1)";
                  ...
                  <tr>
                  <td>TEL 3</td>
                  <td><input type="text" name="tel3" value="" id="tel3_ref" pattern="[0-9]{1,20}" 
                    title="TEL 2 không vượt quá 20 ký tự" required></td>
                </tr>
                  <tr>
                    <td>ZIPNO</td>
