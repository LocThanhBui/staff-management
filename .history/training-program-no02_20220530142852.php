...
<body>
  ...
  <div class="container">
    <form action="" method="post">
      <table class="table table-brored bg-secondary text-white">
        <th>STAFF MASTER CSV EXPORT</th>

        <tr>
          <td>
            <label for="">STAFF CODE</label>
            <input type="text" name="code_1" id="id__code1">
            ~
            <input type="text" name="code_2" id="id__code2">
          </td>
        </tr>
        <tr>
          <td> NAME
        ...
        <tr>
          <td id="td_control">
            <button type="submit" class="btn btn-success" name="export_csv_data" id="btnEx">Export</button>
