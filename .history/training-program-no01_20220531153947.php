  ...
  <script type="text/javascript">
    $(function() {
      ...
      $('#tbl tr').click(function(e) {
        ...
        // var department = $(this).closest('.tr_action').find('td:nth-child(3)').text();
        // var department_name = $(this).closest('.tr_action').find('td:nth-child(3)').text();
        ...
        $('#btnUpdate').click(function(e) {
          ...
          $('#code').val(staffcode);
          $('#name').val(staffname);
          // $('#id_department :selected').text(department);
          // $('#id_department_name').val(department);
        ...
        $('#btnDelete').click(function(e) {
          ...
          // $('#department_name_de').val(department_name);
    ...
    <div class="container mt-3 ">
      ...
      <tr>
        <td>
          ...
          <button type="submit" class="btn btn-outline-warning" data-toggle="modal" id="btnUpdate" data-target="#myModalUpdate" disabled>Update</button>
