              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  if (isset($_POST['btn_Add'])) {
                    ...
                    $sqlAdd = " INSERT INTO `m_user` (`code`, `name`, `birthday`, `tel1`, `tel2`,`tel2` , `zipno`, `address1`, `address2`, `note`, `useflag`) VALUES ('$staff_code', '$staff_name', '$birthday', '$tel1', '$tel2', '$zip', '$add1', '$add2', '$note', 1)";
