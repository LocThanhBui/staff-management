...
<body>
  ...
  <div class="container">
            ...
            <div class="container mt-3">
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    <td>STAFF NAME</td>
                    <td><input  type="text" name="name" value="" id="name" pattern="[a-z][0-9]{10,50}" 
                  ...
                  <tr>
                    <td>ADDRESS 1</td>
                    <td><input  type="text" name="address1" value="" id="address1" pattern="[a-z][0-9]{1,100}" 
                    title="ADDRESS 1 không vượt quá 10 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>ADDRESS 2</td>
                    <td><input  type="text" name="address2" value="" id="address2" pattern="[a-z][0-9]{1,100}" 
                    title="ADDRESS 2 không vượt quá 10 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>NOTE</td>
                    <td><input  type="text" name="note" value="" id="note" pattern="[a-z][0-9]{1,100}" 
                    title="NOTE 2 không vượt quá 10 ký tự" required></td>
                  </tr>
                  <tr id="onHide">
                    <td>USEFLAG</td>
    ...
    <script>
      var codeLength = document.querySelector('#code');
      codeLength.oninvalid = function(event) {
