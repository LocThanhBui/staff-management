        ...
        <div class="modal-content">
          <form action="" method="POST">
            <div class="modal-header">
              ...
              <button type="button" class="btn-close" data-dismiss="modal" data-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                <?php
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  <td></td>
                  <td>
                    <input type="button" class="btn btn-danger float-right " data-dismiss="modal" name="btn_Cancel" value="OK">
                  </td>
                </tr>
              </table>
            </div>
