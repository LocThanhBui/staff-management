              ...
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  ...
                  <td><input type="text" name="name" value="<?php echo $row["name"]; ?>" id="name" pattern="[a-z]{1,50}" 
                    title="STAFFNAME không vượt quá 50 ký tự"
                    required></td>
                </tr>
                ...
                <tr>
                  <td>TEL 1</td>
                  <td><input type="text" name="tel1" value="<?php echo $row["tel1"] ?>" id="tel1" pattern="[0-9]{1,10}" 
                    title="TEL 1 không vượt quá 10 ký tự" required></td>
                </tr>
                <tr>
                  <td>TEL 2</td>
                  <td><input type="text" name="tel2" value="<?php echo $row["tel2"]; ?>" id="tel2" pattern="[0-9]{1,10}" 
                    title="TEL 2 không vượt quá 10 ký tự" required></td>
                </tr>
                <tr>
                  <td>ZIP NO</td>
                  <td><input type="text" name="zip" value="<?php echo $row["zipno"] ?>" id="zip" pattern="[0-9]{1,10}" 
                    title="ZIPNO không vượt quá 10 ký tự" required></td>
                </tr>
                <tr>
                  <td>ADDRESS 1</td>
                  <td><input type="text" name="address1" value="<?php echo $row["address1"]; ?>" id="address1" pattern="[a-z]{1,100}[0-9]{1,100}" 
                    title="ADDRESS 1 không vượt quá 10 ký tự" required></td>
                </tr>
                <tr>
                  <td>ADDRESS 2</td>
                  <td><input type="text" name="address2" value="<?php echo $row["address2"]; ?>" id="address2" pattern="[a-z]{1,100}[0-9]{1,100}" 
                    title="ADDRESS 2 không vượt quá 10 ký tự" required></td>
                </tr>
                <tr>
                  <td>NOTE</td>
                ...
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    ...
                    <td>
                     ...
                     title="STAFFCODE phải là số và không vượt quá 6 ký tự" required>
                    </td>
                  </tr>
                  <tr>
                    <td>STAFF NAME</td>
                  ...
                  <tr>
                    <td>BIRTHDAY</td>
                    <td><input  type="date" name="birthday" value="" id="birthday" required></td>
                  </tr>
                  <tr>
                    <td>TEL 1</td>
                    <td><input  type="text" name="tel1" value="" id="tel1" pattern="[0-9]{1,10}" 
                    title="TEL 1 không vượt quá 10 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>TEL 2</td>
                    <td><input  type="text" name="tel2" value="" id="tel2" pattern="[0-9]{1,10}" 
                    title="TEL 2 không vượt quá 10 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>ZIPNO</td>
          ...
          <form action="" method="POST">
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  <td>STAFF CODE</td>
                  <td><input type="text" name="code" value="<?php echo $row["code"]; ?>" id="code_ref" read>
                  </td>
                </tr>
                <tr>
                  <td>STAFF NAME</td>
                  <td><input type="text" name="name" value="<?php echo $row["name"]; ?>" id="name_ref" read></td>
                </tr>
                <tr>
                  <td>BIRTHDAY</td>
                  <td><input type="date" name="birthday" value="<?php echo $row["birthday"]; ?>" id="birthday_ref" read></td>
                </tr>
                <tr>
                  <td>TEL 1</td>
                  <td><input type="text" name="tel1" value="<?php echo $row["tel1"]; ?>" id="tel1_ref" read></td>
                </tr>
                <tr>
                  <td>TEL 2</td>
                  <td><input type="text" name="tel2" value="<?php echo $row["tel2"]; ?>" id="tel2_ref" read></td>
                </tr>
                <tr>
                  <td>TEL 3</td>
                  <td><input type="text" name="tel3" value="<?php echo $row["tel3"]; ?>" id="tel3_ref" read></td>
                </tr>
                <tr>
                  <td>ZIP NO</td>
                  <td><input type="text" name="zip" value="<?php echo $row["zipno"] ?>" id="zip_ref" read></td>
                </tr>
                <tr>
                  <td>ADDRESS 1</td>
                  <td><input type="text" name="address1" value="<?php echo $row["address1"]; ?>" id="address1_ref" read></td>
                </tr>
                <tr>
                  <td>ADDRESS 2</td>
                  <td><input type="text" name="address2" value="<?php echo $row["address2"]; ?>" id="address2_ref" read></td>
                </tr>
                <tr>
                  <td>NOTE</td>
                  <td><input type="text" name="note" value="<?php echo $row["note"]; ?>" id="note_ref" read></td>
                </tr>
                <tr id="onHide">
                  <td>USEFLAG</td>
