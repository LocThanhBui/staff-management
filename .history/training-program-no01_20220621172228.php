            ...
            <div class="container mt-3">
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    <td>ADDRESS 1</td>
                    <td><input  type="text" name="address1" value="" id="address1" pattern="[a-zA-Z0-9].{10,100}" 
                    title="ADDRESS 1 không vượt quá 100 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>ADDRESS 2</td>
                    <td><input  type="text" name="address2" value="" id="address2" pattern="[a-zA-Z0-9].{30,100}" 
                    title="ADDRESS 2 không vượt quá 10 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>NOTE</td>
