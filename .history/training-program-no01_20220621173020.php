...
<body>
  ...
  if (!empty($_POST["btnDelete"]) && isset($_POST['code'])) {
    $sqlDelete = "UPDATE `m_user` SET `useflag` = 0 where `code` =" . $_POST['code'];
        ...
        ?>
          ...
          <tbody>
            <tr class="tr_action" onclick="checkBtn()">
              <td id="code_tr"><?php echo $staff_code; ?></td>
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                if (isset($_POST['btn_Update']) && isset($_POST['code'])) {
                  ...
                  $sqlUpdate = " UPDATE `m_user` SET `name` = '$staff_name',`birthday` = '$birthday',`tel1` = '$tel1', `tel2` = '$tel2', `zipno` = '$zip',`address1` = '$address1', `address2` = '$address2', `note` = '$note' where `code` =" . $_POST['code'];
                ...
                <tr>
                  <td>STAFF NAME</td>
                  <td><input type="text" name="name" value="<?php echo $row["name"]; ?>" id="name" pattern="[A-Za-z].{10,50}" 
                ...
                <tr>
                  <td>ADDRESS 1</td>
                  <td><input type="text" name="address1" value="<?php echo $row["address1"]; ?>" id="address1" pattern="[a-zA-Z0-9].{5,100}" 
                    title="ADDRESS 1 không vượt quá 100 ký tự"  required></td>
                </tr>
                <tr>
                  <td>ADDRESS 2</td>
                  <td><input type="text" name="address2" value="<?php echo $row["address2"]; ?>" id="address2" pattern="[a-zA-Z0-9].{3,100}" 
                    title="ADDRESS 2 không vượt quá 100 ký tự"  required></td>
                </tr>
                <tr>
                  <td>NOTE</td>
            ...
            <div class="container mt-3">
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    <td>STAFF NAME</td>
                    <td><input  type="text" name="name" value="" id="name" pattern="[A-Za-z].{10,50}" 
                    title="STAFFNAME không vượt quá 50 ký tự"
                    required></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>ADDRESS 1</td>
                    <td><input  type="text" name="address1" value="" id="address1" pattern="[a-zA-Z0-9].{5,100}" 
                    title="ADDRESS 1 không vượt quá 100 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>ADDRESS 2</td>
                    <td><input  type="text" name="address2" value="" id="address2" pattern="[a-zA-Z0-9].{3,100}" 
