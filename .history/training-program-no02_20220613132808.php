      ...
      <table class="table bg-secondary text-white">
        ...
        <tr>
          <td>
            ...
            <input type="text" name="code_1" id="id__code1" placeholder="" pattern="[0-9]{1,10}" 
                    title="StaffCode không vượt quá 10 ký tự" required>
            ~
            <input type="text" name="code_2" id="id__code2" pattern="[0-9]{1,10}" 
                    title="StaffCode không vượt quá 10 ký tự" required>
          </td>
        </tr>
        <tr>
          <td> NAME
            <form action="" method="post">
              <input type="text" class="search form-control" placeholder="Search staff name" pattern="[a-z]{1,50}" 
                    title="NAME không vượt quá 50 ký tự"
                    required>
              <p id="searchValue"></p>
            </form>
          </td>
