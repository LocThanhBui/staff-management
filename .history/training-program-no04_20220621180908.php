            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                if (isset($_POST['btn_Update']) && isset($_POST['department_code'])) {
                  ...
                  $sqlUpdate = "UPDATE `m_department` SET `department_name`='$department_name',`tel`=' $tel',`mail`='$mail',`description`=' $desc',`note`=' $note' WHERE `department_code` =" . $_POST['department_code'];
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" id="code" value="<?php echo $row["department_code"]; ?>" name="department_code" readonly>
                  </td>
                </tr>
                <tr>
                  <td>DEPARTMENT NAME</td>
                  <td><input type="text" id="name" name="department_name" value="<?php echo $row["department_name"]; ?>" pattern="[A-Za-z].{10,50}"
                ...
                <tr>
                  <td>MAIL</td>
                  <td><input type="email" id="mail" name="mail" value="<?php echo $row["mail"]; ?>"  required></td>
                </tr>
                <tr>
                  <td>DESCRIPTION</td>
