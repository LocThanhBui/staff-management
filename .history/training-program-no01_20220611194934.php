              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    ...
                    <td>
                      <input  type="text" value="" name="code" id="code" maxlength="6" pattern="[0-9]{6}"
                     title="Staff Code phải là số và không vượt quá 6 ký tự" required>
                    </td>
                  </tr>
                  <tr>
                    <td>STAFF NAME</td>
                    <td><input  type="text" name="name" value="" id="name" maxlength="6" pattern="[a-z][0-9]{50}" 
                    title="Staff Name phải là số và không vượt quá 6 ký tự"
                    required></td>
                  </tr>
                  <tr>
                    <td>BIRTHDAY</td>
                  ...
                  <tr>
                    <td>TEL 1</td>
                    <td><input  type="text" name="tel1" value="" id="tel1" required></td>
                  </tr>
                  <tr>
                    <td>TEL 2</td>
                    <td><input  type="text" name="tel2" value="" id="tel2" required></td>
                  </tr>
                  <tr>
                    <td>ZIPNO</td>
