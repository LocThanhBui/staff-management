            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  ...
                  <td><input type="text" id="name" name="name" value="<?php echo $row["department_name"]; ?>" pattern="[a-z]{1,50}" 
                    title="DEPARTMENTNAME không vượt quá 50 ký tự"
                    required></td>
                </tr>
                <tr>
                  <td>TEL</td>
                  <td><input type="text" id="tel" name="tel" value="<?php echo $row["tel"]; ?>" pattern="[0-9]{1,10}" 
                    title="TEL không vượt quá 20 ký tự" required></td>
                </tr>
                <tr>
                  <td>MAIL</td>
                  <td><input type="email" id="mail" name="mail" value="<?php echo $row["mail"]; ?>" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required></td>
                </tr>
                <tr>
                  <td>DESCRIPTION</td>
                  <td><input type="text" id="desc" name="desc" value="<?php echo $row["description"]; ?>" pattern="[a-z]{1,200}" 
                    title="DEPARTMENTNAME không vượt quá 200 ký tự"
                    required></td>
                </tr>
                <tr>
                  <td>NOTE</td>
              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="text" value="" name="code" pattern="[0-9]{1,6}"
                     title="DEPARTMENTCODE phải là số và không vượt quá 6 ký tự" required>
                    </td>
                  </tr>
                  <tr>
                    <td>DEPARTMENT NAME</td>
                    <td><input type="text" name="name" value="" pattern="[a-z]{1,50}" 
                    title="DEPARTMENTNAME không vượt quá 50 ký tự"
                    required></td>
                  </tr>
                  <tr>
                    <td>TEL</td>
                    <td><input type="text" name="tel" value="" pattern="[0-9]{1,10}" 
                    title="TEL không vượt quá 20 ký tự" required></td>
                  </tr>
                  <tr>
                    <td>MAIL</td>
                    <td><input type="email" name="mail" value="" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,4}$" required></td>
                  </tr>
                  <tr>
                    <td>DESC</td>
                    <td><input type="text" name="desc" value="" pattern="[a-z]{1,200}" 
                    title=" không vượt quá 200 ký tự"
                    required></td>
                  </tr>
                  <tr>
                    <td>NOTE</td>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <button type="button" class="btn btn-danger float-right" data-dismiss="modal" data-bs-dismiss="modal">Cancel</button>
                    </td>
                  </tr>
                </table>
              </form>
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  ...
                  <td>
                    <input type="text" id="code_delete" value="<?php echo $row["department_code"]; ?>" name="code" readonly>
                  </td>
                </tr>
                <tr>
                  <td>DEPARTMENT NAME</td>
