          ...
          <form action="" method="POST">
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  <td>DESCRIPTION</td>
                  <td><input type="text" id="desc" name="desc" value="<?php echo $row["description"]; ?>" pattern="[a-z]{1,200}[0-9]{1,200}" 
            ...
            <div class="container mt-3">
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    <td>DEPARTMENT NAME</td>
                    <td><input type="text" name="name" value="" pattern="[A-Za-z].{10,50}"
                    title="DEPARTMENTNAME không vượt quá 50 ký tự"
                    required></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>DESCRIPTION</td>
                    <td><input type="text" name="desc" value="" pattern="[a-z]{1,200}[0-9]{1,200}" 
                    title=" DESCRIPTION không vượt quá 200 ký tự"
                    required></td>
                  </tr>
                  <tr>
