              ...
              <form action="" method="POST">
                <table class="table bg-secondary text-white">
                  ...
                  <tr>
                    ...
                    <td>
                      <input  type="text" value="" name="code" id="code" minlength="1" maxlength="6" pattern="[0-9]{6}"
                     title="StaffCode phải là số và không vượt quá 6 ký tự" required>
                    </td>
                  </tr>
                  <tr>
                    <td>STAFF NAME</td>
                    <td><input  type="text" name="name" value="" id="name" maxlength="50" pattern="[a-z][0-9]{50}" 
