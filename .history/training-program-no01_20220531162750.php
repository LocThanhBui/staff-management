...
<head>
  ...
  <script type="text/javascript">
    var disUpdate = document.querySelector('#btnUpdate') = false;
    var disDelete = document.querySelector('#btnDelete');
    function checkBtn() {
      var disUpdate = document.querySelector('#btnUpdate') = true;
