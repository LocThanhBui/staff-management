          ...
          <form action="" method="POST">
            ...
            <div class="modal-body">
              <table class="table table-bordered bg-secondary text-white">
                ...
                <tr>
                  <td>STAFF CODE</td>
                  <td><input type="text" name="code" value="<?php echo $row["code"]; ?>" id="code_ref" re>
                  </td>
                </tr>
                <tr>
                  <td>STAFF NAME</td>
                  <td><input type="text" name="name" value="<?php echo $row["name"]; ?>" id="name_ref" re></td>
                </tr>
                <tr>
                  <td>BIRTHDAY</td>
                  <td><input type="date" name="birthday" value="<?php echo $row["birthday"]; ?>" id="birthday_ref" re></td>
                </tr>
                <tr>
                  <td>TEL 1</td>
                  <td><input type="text" name="tel1" value="<?php echo $row["tel1"]; ?>" id="tel1_ref" re></td>
                </tr>
                <tr>
                  <td>TEL 2</td>
                  <td><input type="text" name="tel2" value="<?php echo $row["tel2"]; ?>" id="tel2_ref" re></td>
                </tr>
                <tr>
                  <td>TEL 3</td>
                  <td><input type="text" name="tel3" value="<?php echo $row["tel3"]; ?>" id="tel3_ref" re></td>
                </tr>
                <tr>
                  <td>ZIP NO</td>
                  <td><input type="text" name="zip" value="<?php echo $row["zipno"] ?>" id="zip_ref" re></td>
                </tr>
                <tr>
                  <td>ADDRESS 1</td>
                  <td><input type="text" name="address1" value="<?php echo $row["address1"]; ?>" id="address1_ref" re></td>
                </tr>
                <tr>
                  <td>ADDRESS 2</td>
                  <td><input type="text" name="address2" value="<?php echo $row["address2"]; ?>" id="address2_ref" re></td>
                </tr>
                <tr>
                  <td>NOTE</td>
                  <td><input type="text" name="note" value="<?php echo $row["note"]; ?>" id="note_ref" re></td>
                </tr>
                <tr id="onHide">
                  <td>USEFLAG</td>
